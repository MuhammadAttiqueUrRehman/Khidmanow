 ...
 */
public class fr_multiprice extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fr_multiprice, container, false);
        ...
        try {
            adapter = new serviceList(getContext(), servicelist, "1");
        ...
        servicelist.clear();
        intromanager.setMultiFormType("1");
        ...
        try {
            ...
            for (int i = 0; i < json_array_item.length(); i++) {
                ...
                spinClass spin = new spinClass(objects.getString("multichoicecode"), objects.getString("multichoicename"), i, mc,
                        Double.parseDouble(objects.getString("multichoiceprice")) /*0.0*/, 1);
