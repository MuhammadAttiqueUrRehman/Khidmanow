 ...
 */
public class fr_multionly extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fr_multionly, container, false);
        ...
        quest1.setText(intromanager.getMultiChoiceQuestion());
        intromanager.setMultiFormType("0");
        try {
            adapter = new serviceList(getContext(), servicelist, "0");
        ...
        try {
            ...
            for (int i = 0; i < json_array_item.length(); i++) {
                ...
                spinClass spin = new spinClass(objects.getString("multichoicecode"), objects.getString("multichoicename"), i, mc, 0.0, 0);
