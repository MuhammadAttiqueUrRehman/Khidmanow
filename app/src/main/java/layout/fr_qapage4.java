 ...
 */
public class fr_qapage4 extends Fragment {
    Toolbar mtoolbar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     //   View v =  inflater.inflate(R.layout.fragment_fr_qapage1, container, false);
        v = inflater.inflate(R.layout.fragment_fr_qapage4, container, false);
    ...
    /*    Toolbar mtoolbar = (Toolbar) v.findViewById(R.id.toolbar);
     ...
     //   previous=(Button) v.findViewById(R.id.btnprev);
        ...
        serviceadapter = new questionAdapter(getActivity(), (ArrayList<detailitemVO>) detailList,R.layout.radio_option,4,intromanager.getQAOption4());
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Boolean bool = hmcoredata.checkForm(getActivity(),intromanager.getQAOption4());
                if (!bool){
                    return;
                }
         ...
         /*       Fragment myFragment;
                ...
                try {
                    myjson = new JSONObject(intromanager.getServiceOP());
                    newArray = myjson.getJSONArray("question5");
                } catch (JSONException e) {
                    e.printStackTrace();
                    hmcoredata.showToast(getActivity(), e.getMessage());
                    return;
    ...
    /*    mtoolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment myFragment= new fr_qapage3();
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_0, myFragment).addToBackStack(null).commitAllowingStateLoss();
            }
        });
