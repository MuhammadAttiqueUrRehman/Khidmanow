 ...
 * {@link fr_qapage3.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link fr_qapage3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fr_qapage3 extends Fragment {
    Toolbar mtoolbar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  View v =  inflater.inflate(R.layout.fragment_fr_qapage1, container, false);
        v = inflater.inflate(R.layout.fragment_fr_qapage3, container, false);
     ...
     //   previous=(Button) v.findViewById(R.id.btnprev);
        ...
        serviceadapter = new questionAdapter(getActivity(), (ArrayList<detailitemVO>) detailList,R.layout.radio_option,3,intromanager.getQAOption3());
   ...
   /*     mtoolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Boolean bool = hmcoredata.checkForm(getActivity(),intromanager.getQAOption3());
                if (!bool){
                    return;
                }

                Fragment myFragment= new fr_qapage2();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             ...
             /*   Fragment myFragment;
                ...
                try {
                    myjson = new JSONObject(intromanager.getServiceOP());
                    newArray = myjson.getJSONArray("question4");
                } catch (JSONException e) {
                    e.printStackTrace();
                    hmcoredata.showToast(getActivity(), e.getMessage());
                    return;
