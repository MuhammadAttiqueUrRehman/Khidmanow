 ...
 */
public class postcouponlist extends Fragment implements AsyncResponse {
    ...
    private void fetchServices() {
        ...
        try {
            ...
            aasyncTask.delegate = (AsyncResponse) postcouponlist.this;
    ...
    public void processFinish(String output, String mview) throws HMOwnException, JSONException {
        ...
        adapter = new postVoucherLookupAdapter(getContext(), ar,postcouponlist.this,"C");
