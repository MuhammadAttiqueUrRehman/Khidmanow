 ...
 */
public class fr_refundpolicy extends Fragment implements AsyncResponse {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_fr_refundpolicy, container, false);

        Toolbar mtoolbar = (Toolbar) v.findViewById(R.id.toolbar);
        ((AppCompatActivity) getActivity()).setSupportActionBar(mtoolbar);
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(R.string.refund_cancellation);
        ...
        try {
            ...
            jsonMain.put("reference", HMConstants.refundPolicy);
        ...
        try {
            ...
            aasyncTask.delegate = (AsyncResponse) fr_refundpolicy.this;
